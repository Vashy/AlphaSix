...
class Processor():
    ...
    def prepare_message(self) -> dict:
        ...
        if utenti_interessati == []:
            ...
            print('Utente con priorità più alta in caso non ci sia nessuno: ' + utenti_interessati)
        ...
        # tra quelle disponibili e interessate al topic
            ...
            print('Utente con priorità più alta interessato: ' + utenti_interessati)
    ...
    def filter_users_with_max_priority(self, users: list, project: str) -> list:
        return self._mongofacade.get_users_from_list_with_max_priority(users, project)
