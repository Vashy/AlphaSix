...
\input{template/layout} %template/layout} % Layout del documento 
...
\begin{document}
    ...
    \section{Informazioni generali}
        ...
        \subsection{Argomenti}
            ...
            Ogni membro ha espresso con ordine i suoi punti a favore e a sfavore di ogni \gloss{capitolato}.\par
            ...
            Viene valutato positivamente come \gloss{progetto} per i motivi esposti nello \Doc{\SdFv}.
