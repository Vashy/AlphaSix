...
\section{Processi di supporto}\label{PS}
	...
	\subsection{Verifica e validazione}\label{Verifica}
		...
		Può essere effettuata sui documenti o sul codice in maniera statica.
            ...
            I \gloss{moduli} devo essere sempre testati per assicurasi la loro correttezza, per fare ciò devono essere testate le \gloss{unità} che li compongono attraverso i test di unità in \S\ref{testunita}.
