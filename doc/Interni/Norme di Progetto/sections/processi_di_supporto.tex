...
\section{Processi di supporto}\label{PS}
	...
	\subsection{Codice sorgente}\label{PS:Codice}
		...
		% \paragraph{Continous Delivery}\label{CD} 
		%TODO: Magari più avanti?
	...
	\subsection{Verifica}\label{Verifica}
		...
		Può essere effettuata sui documenti o sul codice in maniera statica. 
			...
			Con essa è possibile rilevare bug, \gloss{code smell}, duplicazione del codice e vulnerabilità varie.
			In particolare, ci è molto utile perchè supporta il linguaggio di programmazione che noi utilizziamo: Python.
			%TODO: inserire screen
			...
			A questo scopo, SonarQube ci dà la possibilità di visualizzare quanti bug sono presenti nel codice.
			\textbf{Metrica}: numero di bug presenti.
			...
			A questo scopo, SonarQube ci dà la possibilità di visualizzare le vulnerabilità presenti nel codice.
			\textbf{Metrica}: numero di vulnerabilità presenti.

			\subparagraph{MPS003 Presenza di code smell} \label{presenzacodesmell}
			I code smell non sono 
			\textbf{Metrica}: numero di code smell presenti.

			\subparagraph{MPS004 Duplicazione del codice} \label{duplicazionecodice}

			\textbf{Metrica}: percentuale di codice duplicato.
