...
\section{Processi di supporto}\label{PS}
	...
	\subsection{Documentazione}\label{PS:Documentazione}
		...
		\subsubsection{Design}\label{PS:Documentazione:Design}
			...
			Ogni documento, nel momento in cui viene ritenuto pronto, deve essere revisionato dal \Res\ affinchèTODO ne venga controllata l'adeguatezza e approvato il rilascio.
	...
	Il processo di \gloss{quality assurance} ci fornisce l'adeguata certezza che il nostro prodotto software e processi siano conformi ai loro specifici requisiti e che aderiscano ai piani stabiliti per essi.
		...
		\input{sections/standard_qualita}
	...
	\subsection{Verifica e validazione}\label{Verifica}
		...
		Il \Ver\ ha il compito di verificare la progettazione da noi svolta.
		...
		Può essere effettuata sui documenti o sul codice in maniera statica.
            ...
            I \gloss{moduli} devo essere sempre testati per assicurasi la loro correttezza, per fare ciò devono essere testa le \gloss{unità} che li compongono attraverso i test di unità in \S\ref{testunita}.
		...
		Per effettuare analisi dinamica è necessario sviluppare dei dei test che verifichino l'integrità dei prodotti. Questi sono classificati attraverso un identificativo univoco descritto in \S\ref{ClassificazioneTest} e suddivisi per tipo in base alla tipologia dell'oggetto di test.
			...
			Tutti i test da noi delineati presentano un tracciamento in forma tabellare con i requisiti o componenti applicative a loro associati.
			Questo ci assicura una verifica più completa.
