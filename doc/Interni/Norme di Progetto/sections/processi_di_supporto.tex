...
\section{Processi di supporto}\label{PS}
	...
	\subsection{Verifica e validazione}\label{Verifica}
        ...
        \[{\sum_{i=1} \frac{x_i}{y_i}}100\] $x_i=$ numero di volte che il valore della i-esima metrica è sopra il valore della soglia minima e sotto il valore della soglia massima. \par
