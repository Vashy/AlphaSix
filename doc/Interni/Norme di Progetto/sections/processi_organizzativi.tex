\section{Processi Organizzativi}
    ...
    \subsection{Gestione del progetto}
		...
		\subsubsection{Pianificazione di attività}
			...
			\paragraph{Scopo}
			\Res\ e \Amm\ insieme si occupano di generare il \Doc{\PdPv} che tratta generalmente:
			\begin{itemize}
			...
			Ad esempio con P01-021 si può intuitivamente capire che si tratta del primo rischio del personale, di gravità accettabile, probabilità alta e un valore di classe medio.
		...
		\subsubsection{Chiusura dei processi}
			...
			verranno archiviati in apposite \gloss{repository}. Alla versione \textit{1.0.0} del presente documento, gli unici prodotti che verranno
			...
			anomalie verranno opportunamente archiviati. % FIXME Archiviate? Come? Dove?
...
%TODO: aggiungere gloss se non sono state menzionate prima queste tecnologie
		...
		\begin{itemize}
			\item Lo studio della documentazione\footnote{Tutti i vari link per la documentazione sono presenti in ''Link delle documentazioni, utili alla formazione'' nella sezione \S{1.5.1}} di tecnologie e metodologie quali:
			\begin{itemize}
				\item \LaTeX 
				\item Redmine 
				\item GitLab 
