\section{Processi organizzativi}
    ...
    \subsection{Gestione del progetto}\label{GestioneProgetto}
        ...
        Gli obiettivi per la qualità (Q) concordati dall'\Amm\ e dal \Ver, descritti nel \PdQd, avranno il seguente codice identificativo:
		...
		\subsubsection{Pianificazione di attività}
			...
			\paragraph{Obiettivo}
			L'obiettivo che ci poniamo di raggiungere tramite il \PdPd\ è organizzare il lavoro con \gloss{efficenza} ed \gloss{efficacia},
			...
			Engineering\footnote{Riferirsi alla voce
			% ``Software Engineering, 10° edizione''
			19
			 in \S\ref{rifinfo}} e possono essere di tipo:
			\begin{itemize}
			...
			I ruoli\footnote{Riferirsi alla voce
			% ``Descrizione dei ruoli di progetto''
			4
			 in \S\ref{rifinfo}.} adoperati per lo sviluppo del progetto sono:
    	...
    	\subsubsection{Strumenti organizzativi}\label{PianificazioneCoordinamento}
			...
			Come strumento di monitoraggio delle ore di orologio usiamo Toggl\footnote{Riferirsi alla voce
			% ``Toggl''
			22
			 in \ref{rifinfo} per maggiori informazioni},
