\section{Processi primari}\label{ProcessiPrimari}
    ...
    \subsection{Processo di fornitura}\label{PP:Fornitura}	%istanziare Management Process, Infrastructure Process e Improvement Process
		...
		\subsubsection{Normazione}\label{Normazione} % TODO: aggiungere PoC a Glossario
    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
		...
		\paragraph{Metriche}\label{ProcessiPrimariMetriche}
		...
		\paragraph{Diagrammi delle classi}\label{PP:Sviluppo:DiagrammiClassi} %TODO
		%Contenuto
...
\end{lstlisting}
        ...
        % \paragraph{Costruttore} %TODO roba da js
        %Contenuto

        % \paragraph{Operatore di espansione} %TODO Altra roba da js
        %Contenuto
        ...
        % \paragraph{Punti e virgola} %TODO Niente punti e virgola in Python!
        %Contenuto
...
\end{lstlisting}
		...
		Il primo è proprietario e supportato dal team di NetBeans, il secondo è un progetto \gloss{open source} di Microsoft, che ha
