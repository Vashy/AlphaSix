...
\end{lstlisting}
		...
		Per ottenere stringhe formattabili con parametri, usare le f-stringhe introdotte con Python 3.6.
...
\end{lstlisting}
	    ...
	    \subparagraph{IDE} % NOTE: controllare la sezione relativa a VSC sui processi di supporto
