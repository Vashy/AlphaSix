\section{Processi Primari}\label{PP}
    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
		...
		Lo sviluppo consiste nell'affrontare le attività volte a produrre il software richiesto dal proponente. Per una corretta implementazione di questo \glossary{processo} è necessario:
		\begin{itemize}
		...
		\begin{itemize}
			...
			\item Modellazione concettuale del \gloss{sistema} tramite la definizione dei vari casi d'uso
		...
		Per i diagrammi dei casi d'uso viene utilizzato lo strumento \gloss{Draw.io} e il linguaggio \gloss{UML} 2.0. Essi descrivono la visione di un utente esterno al sistema e non danno nessun dettaglio implementativo. I componenti contenuti in questo tipo di diagrammi sono:
		\begin{itemize}
			\item Attore
			\item Caso d'uso
