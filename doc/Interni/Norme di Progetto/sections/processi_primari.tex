\section{Processi primari}\label{ProcessiPrimari}
    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
		...
		Per i diagrammi dei casi d'uso utilizziamo lo strumento \gloss{Draw.io} e il linguaggio \gloss{UML} 2.0. Questi diagrammi descrivono ad alto livello i tipi di oggetto presenti nel sistema e le relazioni che intercorrono tra essi.
		...
		\begin{itemize}
			\item \textbf{Attributi}: rappresentano lo stato dell'oggetto. Presentano le caratteristiche:
			    \begin{itemize}
			        \item \textbf{Visibilità}: pubblica, privata, protetta o di package, rispetto alle altre classi.
