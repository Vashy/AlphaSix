\section{Processi primari}\label{ProcessiPrimari}
    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
        ...
        \begin{itemize}
            ...
            %TODO: la mettiamo? \item \textbf{Associazione}: rappresentata da una linea continua semplice, indica che una classe posssiede uno o più attributi (a seconda delle molteplicità indicate sulla linea) dell'altra, o viceversa.
