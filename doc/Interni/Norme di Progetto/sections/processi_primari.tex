\section{Processi primari}\label{ProcessiPrimari}
    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
        ...
        Per i diagrammi dei package utilizziamo lo strumento \gloss{Draw.io} e il linguaggio \gloss{UML} 2.0.\\
        ...
        Nella progettazione adottiamo il principio del common closure principle, secondo il quale elementi dello stesso package condividono la stessa causa di cambiamento.\\\\
        ...
        Per i diagrammi delle attività utilizziamo lo strumento \gloss{Draw.io} e il linguaggio \gloss{UML} 2.0.\\
