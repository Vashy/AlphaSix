\section{Processi primari}\label{PP}
    ...
    \subsection{Processo di fornitura}\label{PP:Fornitura}	%istanziare Management Process, Infrastructure Process e Improvement Process
		...
		%L’Amministratore apporta incrementi all’insieme di regole che ogni componente del gruppo deve seguire durante lo svolgimento delle attività e dei compiti a lui assegnati. Con il procedere del progetto, si acquisiscono nuove conoscenze o si incontrano difficoltà che potrebbero richiedere la modifica di queste regole....
    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
        ...
        %L’attività di progettazione è svolta dai progettisti ed include le seguenti sotto-attività...
		...
		\paragraph{Diagrammi delle classi} %TODO
		%Contenuto
		...
		\paragraph{Diagrammi di attività} %TODO
		%Contenuto
		...
		\paragraph{Diagrammi di sequenza} %TODO
		%Contenuto
		...
		\subsubsection{Qualità della progettazione} %TODO
        ...
        \subsubsection{Codifica}\label{PP:Sviluppo:Codifica} %TODO: scrivere nei prossimi paragrafi tutto quello che potrebbe essere idealmente scritto in un file di checkstyle. Struttura presa come spunto da Breaking Bug RA.
        %Contenuto
        
        \paragraph{Intestazione} %TODO
        %Intestazione di file e funzioni
        
        \paragraph{Dichiarazione di variabili}  %TODO
        %Contenuto
        
        \paragraph{Costruttore} %TODO
        %Contenuto
        
        \paragraph{Operatore di espansione} %TODO
        %Contenuto
        
        \paragraph{Stringhe} %TODO
        %Contenuto
        
        \paragraph{Parametri delle funzioni} %TODO
        %Contenuto
        
        \paragraph{Funzioni anonime} %TODO
        %Contenuto
        
        \paragraph{Punti e virgola} %TODO
        %Contenuto
        
        \paragraph{Indentazione} %TODO
        %Contenuto
        
        \paragraph{Lunghezza massima delle righe} %TODO
        %Contenuto
        
        \paragraph{Denominazione} %TODO
        %Contenuto
        
        \paragraph{Lunghezza massima di una procedura} %TODO
        %Contenuto
        
        \paragraph{Complessità ciclomatica} %TODO
        %Contenuto
        
        \paragraph{Commenti} %TODO
        %Contenuto
	    ...
	    \subparagraph{IDE} %TODO
	    %Atom o IDEA o Eclipse ecc ecc....
