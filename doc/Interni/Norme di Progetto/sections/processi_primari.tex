    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
		...
		\begin{itemize}
			\item \textbf{R}: si riferisce a requisito.
		 	\item \textbf{Numero}: corrisponde ad un numero progressivo, scritto in 3 cifre, a partire da 1.
		...
		\begin{itemize}
		 	...
		 	%TODO: sarebbe lo scenario secondario?
		\end{itemize}
		...
		Per i diagrammi dei casi d'uso viene utilizzato lo strumento \gloss{Draw.io} e il linguaggio UML 2.0. Essi descrivono la visione di un utente esterno al sistema e non danno
