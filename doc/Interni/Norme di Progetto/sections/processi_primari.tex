\section{Processi primari}\label{ProcessiPrimari}
    ...
    \subsection{Processo di sviluppo}\label{PP:Sviluppo}
		...
		Per i diagrammi delle classi utilizziamo lo strumento \gloss{Draw.io} e il linguaggio \gloss{UML} 2.0.\\
        ...
        Evitiamo ove possibile di usare attributi modificabili dai metodi delle classi, in quanto ostacolano la scrittura dei test ed è meno comprensibile la responsabilità sull'attributo.\\
        ...
        \paragraph{Qualità dei diagrammi dei package} % TODO
		...
		Poiché descrivono gli aspetti dinamici dei casi d'uso, non devono risultare eccesivamente complessi, ma descrivere quanto riportato da casi d'uso e requisiti.\\
