...
\begin{table}[H]
	...
	\begin{oldtabular}{ccccc}
		\toprule
		\multirow{2}{*}{\textbf{Attributi}} & \multicolumn{4}{c}{\textbf{Valutazioni}}\\
	...
	\end{itemize}
		...
		\subparagraph{Descrizione degli attributi della qualità interna e della qualità esterna}
		\begin{itemize}
		...
		\subparagraph{Descrizione degli attributi della qualità in uso}
		\begin{itemize}
	...
	\footnotetext{Riferirsi alla fonte 8 in \S\ref{rifinfo} per la fonte della figura}
	...
	\footnotetext{Riferirsi alla fonte 9 in \S\ref{rifinfo} per la fonte della figura}
    ...
    \subparagraph{Capitolo 7. dell'ISO 90003:2004 realizzazione del prodotto}
