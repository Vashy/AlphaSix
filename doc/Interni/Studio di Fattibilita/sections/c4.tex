\section{MegAlexa - C4} \label{c4}
    ...
    di \gloss{skill} per \gloss{Alexa}, l'assistente vocale di Amazon.
    ...
    \begin{itemize}
    	...
    	\begin{itemize}
            \item \gloss{HTML5}, \gloss{CSS3} (\gloss{Bootstrap}), \gloss{Javscript}
                per il frontend
            \item \gloss{Nodejs} per il backend
    	\end{itemize}
        ...
        \item \gloss{Amazon Web Services} (AWS): servizio scelto per l'hosting del software e del database.
            ...
            \begin{itemize}
                \item \gloss{API Gateway}
                \item \gloss{Lambda}
                \item \gloss{Aurora Serverless}
            \end{itemize}
    \end{itemize}
