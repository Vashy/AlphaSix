\section{Butterfly - C1} \label{c1}
    ...
    Butterfly si presenta come un insieme di \gloss{componenti} che si interfacciano con gli strumenti di sviluppo in modo da recuperare o intercettare le segnalazioni che questi mandano e riportarle all'utente nella forma che quest'ultimo sceglie.\\
    Quest'applicativo deve essere in grado di incanalare le notifiche (contraddistinte da \gloss{Topic} in base alla loro
    ...
    e automatizzare una parte del \gloss{processo} di sviluppo.\par
