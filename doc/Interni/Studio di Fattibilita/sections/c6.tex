\section{Soldino - C6} \label{c6}
    ...
    L'applicativo è composto da una parte che si occupa di gestire gli \gloss{smart contract} e da una parte Web che permetta l'accesso alla \gloss{EVM}.
    ...
    Nonostante l'uso di tecnologie innovative come Blockchain, smart contract e gestione delle tasse in modo automatico, \gruppo\ non ha scelto
