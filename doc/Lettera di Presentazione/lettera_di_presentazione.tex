...
\signature{
	...
	\\\includegraphics[width=5cm]{img/firma_nc}
	\\Nicola Carlesso
...
\begin{document}
	...
	\begin{addmargin}[2em]{2em}
		...
		\begin{itemize}
			\item \Doc{AnalisiDeiRequisiti v1.0.0}
			\item \Doc{PianoDiQualifica v1.0.0}
			\item \Doc{PianoDiProgetto v1.0.0}
			\item \Doc{NormeDiProgetto v1.0.0}
			\item \Doc{Glossario v1.0.0}
			\item \Doc{StudioDiFattibilità v1.0.0}
			\item Verbali interni:
			\begin{itemize}
				\item \Doc{VI\_22-11-2018}
				\item \Doc{VI\_26-11-2018}
				\item \Doc{VI\_17-12-2018}
				\item \Doc{VI\_07-01-2019}
			\end{itemize}
			\item Verbali esterni:
			\begin{itemize}
				\item \Doc{VE\_12-12-2018}
			\end{itemize}
      	\end{itemize}
		...
		come è propriamente riportato nel documento \Doc{PianoDiProgetto v1.0.0}.
