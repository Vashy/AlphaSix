...
\begin{document}
	...
	\begin{addmargin}[2em]{2em}
		...
		\begin{itemize}
			\item \emph{Analisi dei Requisiti v1.0.0}\ped{D};
			\item \emph{Piano di Qualifica v1.0.0}\ped{D};
			\item \emph{Piano di Progetto v1.0.0}\ped{D};
			\item \emph{Norme di Progetto v1.0.0}\ped{D};
			\item \emph{Glossario v1.0.0}\ped{D};
			\item \emph{Studio di Fattibilità v1.0.0}\ped{D};
      	\end{itemize}

		Il gruppo stima di consegnare il prodotto commissionato entro il 17/05/2019. Il costo preventivato è di \mbox{\euro11 890.00},
