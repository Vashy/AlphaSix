...
\signature{
	...
	\\\includegraphics[width=5cm]{img/firma_tg}
	\\Timoty Granziero
...
\begin{document}
	...
	\begin{addmargin}[2em]{2em}
		...
		Con la presente lettera, AlphaSix intende comunicarVi ufficialmente che parteciperà alla Revisione di Accettazione del 2019-05-17 in base all'impegno preso
		...
		\begin{itemize}
			...
			\item \Doc{PianoDiQualifica v4.0.0}
			\item \Doc{PianoDiProgetto v4.0.0}
			\item \Doc{NormeDiProgetto v4.0.0}
            \item \Doc{ManualeSviluppatore v2.0.0}
            \item \Doc{ManualeUtente v2.0.0}
			\item \Doc{Glossario v4.0.0}
			\item \Doc{StudioDiFattibilità v1.0.0}
			\item Verbali interni:
			\begin{itemize}
				\item \Doc{VI\_2019-05-06}
			\end{itemize}
			\item Verbali esterni:
			\begin{itemize}
				\item \Doc{VE\_2019-04-26}
                \item \Doc{VE\_2019-05-08}
			\end{itemize}
      	\end{itemize}

		Il team di sviluppo consegna il prodotto in data 2019-05-16, con relativo collaudo in data 2019-05-17.
		Il costo finale del prodotto è di \mbox{\euro 11600,00},
		come è propriamente riportato nel documento \Doc{PianoDiProgetto v4.0.0}.
