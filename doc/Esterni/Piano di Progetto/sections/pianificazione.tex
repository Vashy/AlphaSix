...
\section{Pianificazione}\label{Pianificazione}
    ...
    \subsection{Analisi dei requisiti}\label{PianificazioneAnalisiDeiRequisiti}
		...
		In questa attività sono stati aggiunti tre rilevamenti riguardanti la qualità, a distanza di una settimana uno
		...
		\begin{itemize}
        	...
        	\end{itemize}
			\item \textbf{II periodo}: dal 2019-02-04 al 2019-02-25
			\begin{itemize}
        	...
        	\end{itemize}
        	\item \textbf{III periodo}: dal 2019-02-27 al 2019-03-07
			\begin{itemize}
				\item \textbf{Pianificazione delle attività}: aggiornamenti della pianificazione.
				\item \textbf{Analisi dei requisiti}
        	...
        	\end{itemize}
        	\item \textbf{IV periodo}: dal 2019-03-09 al 2019-03-14
        	\begin{itemize}
        		\item \textbf{Preparazione per la discussione}: realizzazione della presentazione e studio personale.
        	\end{itemize}
		\end{itemize}
