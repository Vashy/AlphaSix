...
Nell'attività di verifica al termine del periodo dell'analisi dei requisiti è stato redatto un consuntivo di periodo al fine di verificare se il numero di ore assegnate ad ogni ruolo è stato rispettato o meno.
	...
	\begin{table}[H]
		\begin{detailtable}{\columnwidth}{m{3cm}YYYYYYY}
			...
			\thead{Totale}\\\toprule\rowcolor{\tablegray}
			\CV &   & 6 & 3 (+2) & 7  & 16 (-4) & 14 & \\
			\LC & 7 &   & 2 & 10 & 17 &    & \\\rowcolor{\tablegray}
			\MM & 8 (+1) & 6 &   & 8  & 11 & 18 & \\
			\NC & 8 &   &   & 7  &    & 23 (+2) & \\\rowcolor{\tablegray}
			\SG &   & 6 (-2) &   & 16 &    & 16 & \\
			\TG &   &   &   & 14 & 16 (-1) & 10 (-1) & \\\bottomrule
		\end{detailtable}
	...
	\subsubsection{Conclusioni}
	I discostamenti che si sono verificati in questo periodo sono dovuti a impegni imprevisti di alcuni membri del gruppo, ad esempio colloqui con aziende.\par
