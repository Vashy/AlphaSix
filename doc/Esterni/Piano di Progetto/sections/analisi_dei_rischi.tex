...
%	\mydoublerule{\linewidth}{0pt}{2pt}
	...
	\begin{table}[H]
		\begin{risktable}{\columnwidth}{m{1.5cm}m{13.5cm}}
			...
			\multicolumn{2}{X}{
				\textbf{Strategia}: attraverso gli incontri diretti o con strumenti di chat quali \gloss{Telegram} o Slack, ci si confronta e si realizzano i diversi modi di lavorare per ognuno.
			}\\
			\rowcolor{\tablegray}
			\multicolumn{2}{X}{
