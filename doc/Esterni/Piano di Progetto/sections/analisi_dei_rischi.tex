...
\section{Analisi dei rischi} \label{AnalisiDeiRischi}
	...
	Dato il numero non elevato di rischi, si è scelto di mettere solamente tre livelli di gravità e probabilità producendo quindi una matrice con nove elementi. In questo modo i rischi possono essere classificati in tre livelli di importanza:
...
%	\mydoublerule{\linewidth}{0pt}{2pt}
	...
	\footnotetext{Riferirsi alla voce ``Vincoli di organigramma e specifiche economiche'' in \S\ref{rifinfo}}
