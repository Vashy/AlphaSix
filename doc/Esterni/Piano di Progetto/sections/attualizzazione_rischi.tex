...
\section{Attualizzazione dei rischi} \label{AttualizzazioneDeiRischi}
	...
	\begin{table}[H]
		\begin{risktable}{\columnwidth}{m{4cm}m{11cm}}
			...
			\multicolumn{2}{X}{
				\textbf{Strategia adottata}: ognuno ha studiato lo scopo dei vari ruoli e le loro attività da svolgere. Questo per avere una visione globale di quanto sarebbe successo.
			}\\
		\end{risktable}
	...
	\begin{table}[H]
		\begin{risktable}{\columnwidth}{m{4cm}m{11cm}}
			...
			\rowcolor{\tablegray}
			\multicolumn{2}{X}{
				\textbf{Descrizione}: si sono verificate delle incorrettezze durante la verifica dei documenti e dunque l'approvazione è stata errata.
			}\\
			\multicolumn{2}{X}{
				\textbf{Strategia adottata}: le verifiche sono effettuate con più attenzione. \'E necessario dedicare più tempo alle attività di verifica.
			}\\
		\end{risktable}
	...
	\begin{table}[H]
		\begin{risktable}{\columnwidth}{m{4cm}m{11cm}}
			...
			\rowcolor{\tablegray}
			\multicolumn{2}{X}{
				\textbf{Descrizione}: uno dei pc destinato alla presentazione non ha più funzionato al momento occorrente.
			}\\
	...
	\begin{table}[H]
		\begin{risktable}{\columnwidth}{m{4cm}m{11cm}}
			...
			\rowcolor{\tablegray}
			\multicolumn{2}{X}{
				\textbf{Descrizione}: la mancanza di una comunicazione abbastanza approfondita col proponente ci ha portato a dover rivedere nel dettaglio i casi d'uso dell'\AdR.
			}\\
	...
	\begin{table}[H]
		...
		\begin{risktable}{\columnwidth}{m{4cm}m{11cm}}
			...
			\rowcolor{\tablegray}
			\multicolumn{2}{X}{
				\textbf{Descrizione}: l'impegno universitario particolarmente pesante durante le sessioni d'esame e i possibili periodi di malattia da parte dei membri del gruppo, ha causato ritardi nella programmazione. Questo ha portato a un ritardo non previsto nello svolgimento delle attività.
			}\\

			\multicolumn{2}{X}{
				\textbf{Strategia adottata}: abbiamo usato gli strumenti di pianificazione e coordinazione quali \gloss{GitHub} e Slack per coordinarci meglio e gestire il lavoro da ultimare.
			}\\
		\end{risktable}
