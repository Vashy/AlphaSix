...
\section{Attualizzazione dei rischi} \label{AttualizzazioneDeiRischi}
    Per dar senso ai rischi posti in analisi nel {\PdPd} forniamo un resoconto di quanti si sono effettivamente verificati nei periodi di analisi dei requisiti e di progettazione della base tecnologica.\\
    ...
    \begin{table}[H]
		\begin{risktable}{\columnwidth}{m{4cm}m{11cm}}
			...
			\rowcolor{\tablegray}
			\multicolumn{2}{X}{
				\textbf{Descrizione}: il pc di un membro del gruppo continuava a riavviarsi dopo l'installazione di container docker.
			}\\

			\multicolumn{2}{X}{
				\textbf{Strategia adottata}: risolto terminando i container prima dell'avvio completo.
			}\\
		\end{risktable}
