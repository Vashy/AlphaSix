...
Sempre sotto richiesta di \II\ viene utilizzato \gloss{Rancher} come software per la gestione dei container, quindi questa guida verterà principalmente sulla configurazione di \progetto\ utilizzando Rancher. %TODO riverere frase per ripetizione
...
Le specifiche relative alla configurazione delle porte in Rancher possono essere trovate nella pagina dedicata\footnote{\url{https://rancher.com/docs/rancher/v2.x/en/installation/references/}}, alla sezione della documentazione presente nel loro sito.
...
I container sono stati suddivisi in modo da utilizzare un Cluster (nel nostro caso chiamato Butterfly), vari \gloss{Namespace} per separare i servizi fra loro e i %TODO glossarizzare Pod e Namespace
\gloss{Pod} che rappresentano ciascuno un container.
