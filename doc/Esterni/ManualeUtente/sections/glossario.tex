...
\lettera{B}
    ...
    \parola{Broker}{
    Broker è un sistema che distribuisce in maniera trasparente vari aspetti del software su nodi differenti con l'utilizzo di oggetti remoti.
    }
...
\lettera{D}
    ...
    \parola{Default}{
    Con default ci si riferisce allo stato o alla risposta di un sistema qualunque in assenza di interventi espliciti (ad esempio input o configurazioni dell'utente). Si intende con questo termine quindi ``predefinito''.
    }
