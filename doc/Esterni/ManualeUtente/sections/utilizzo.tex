...
Nel caso in cui un utente cerchi di accedere ad una sezione, ma senza aver effettuato l'autenticazione, questo verrà rimandato alla pagina di autenticazione.\par
