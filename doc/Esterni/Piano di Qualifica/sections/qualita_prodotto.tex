...
\begin{table}[H]
    {\def\arraystretch{1.5}
        \begin{tabularx}{\textwidth}{YYY}
            ...
            \\
            \rowcolor{gray!15}
            \multicolumn{3}{>{\hsize=\dimexpr3\hsize+4\tabcolsep}X}{\textbf{Descrizione}: l'esecuzione dei test deve eseguire tutto il codice testato per fare in modo che questo si analizzato in tutti i suoi cammini di esecuzione.}\\
            ...
            \\
            \rowcolor{gray!15}
            \multicolumn{3}{>{\hsize=\dimexpr3\hsize+4\tabcolsep}X}{\textbf{Descrizione}: i test di unità5 eseguiti ad ogni fase di verifica devono essere tutti superati.}\\
