...
Per prodotti è inteso tutto ciò che è concretamente utilizzabile, consultabile o eseguibile. Nel contesto di questo progetto, i prodotti sono documenti e software.
	...
	I documenti rilasciati devono presentarsi leggibili e comprensibili già ad una prima lettura, con contenuti che rispecchino le premesse del documento.
		...
		\begin{itemize}
			...
			\item \textbf{QPD002 Correttezza contenuti}: i contenuti devono rispecchiare ciò che è scritto nei titoli dei paragrafi e dare un valore aggiunto al documento.
...
\begin{itemize} 
	\item \textbf{12}: dato che l'applicazione verrà eseguita nella rete interna dell'azienda, non sarà necessaria una fase di autenticazione dell'utente.
\end{itemize}
...
\begin{itemize}
	\item \textbf{Obiettivo}: viene indicato il codice dell'obiettivo di qualità  ;
