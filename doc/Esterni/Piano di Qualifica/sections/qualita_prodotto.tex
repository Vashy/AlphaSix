...
\begin{table}[H]
    {\def\arraystretch{1.5}
        \begin{tabularx}{\textwidth}{YYY}
            ...
            \\
            \rowcolor{gray!15}
            \multicolumn{3}{>{\hsize=\dimexpr3\hsize+4\tabcolsep}X}{\textbf{Descrizione}: come per i file, anche per i metodi una documentazione è necessaria per capire subito il compito di un metodo, per questo il numero di metodi non documentati deve essere nullo al termine del progetto.}\\
