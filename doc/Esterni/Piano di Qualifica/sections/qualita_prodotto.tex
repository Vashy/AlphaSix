...
%			\item \textbf{QPD004 Manutenibilità del documento}: i documenti devono possedere un diario delle modifiche prontamente aggiornato per agevolarne la manutenibilità.
	...
	Per fare ciò, utilizziamo i dati che ci vengono resi disponibili da \gloss{SonarQube} e le norme dello standard PEP 8\footnote{Riferirsi alla voce ``8. Documentazione PEP8'' in \S\ref{riferimenti informativi}} per l'analisi statica del codice.
