...
In questa sezione vengono riportati i risultati ottenuti a termine del periodo di revisione dei requisiti attraverso le metriche indicate in questo documento. Essi possono coincidere o meno con i valori da noi desiderati e, nel secondo caso in particolar modo, saranno oggetto di valutazioni per il miglioramento descritte all'appendice \S\ref{C}.
	...
	\begin{table}[H]
		{\def\arraystretch{1.5}
			\begin{tabularx}{\textwidth}{YYY}
				...
				\bottomrule
				\multicolumn{3}{>{\hsize=\dimexpr3\hsize+4\tabcolsep}X}{\textbf{Nota}: il valore ottenuto non soddisfa il risultato atteso perché nella prima parte del macro periodo abbiamo prestato molta attenzione alla formazione personale a discapito del tempo che poteva essere dedicato alla verifica dei prodotti.} \\
		\end{tabularx}}
