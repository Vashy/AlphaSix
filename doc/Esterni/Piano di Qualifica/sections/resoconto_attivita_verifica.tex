...
I test che vengono introdotti nel corso del progetto non vanno a sostituire i test precedentemente sviluppati. Ogni test, appena è creato viene eseguito periodicamente fino alla fine del progetto, per evitare che i nuovi cambiamenti possano reintrodurre errori precedentemente risolti.
	...
	Analizzando i risultati ottenuti possiamo dire che per noi sono soddisfacenti rispetto alle nostre aspettative. I voti che abbiamo ottenuto per il nostro lavoro sono stati 25 per la parte relativa alla presentazione e 23 per la parte relativa ai documenti prodotti, che portano ad un voto complessivo di 24. \\
	Quest'ultimo lo abbiamo considerato come poco soddisfacente in quanto ci siamo resi conto degli errori e delle imperfezioni fatte e come poter correggere ed ovviare a questi in modo da produrre un prodotto migliore con documentazione allegata adeguata.\\
	...
	\subsubsection{Considerazioni sui risultati e sull'esito della revisione}
	Dopo aver analizzato i risultati ottenuti durante questo periodo possiamo considerarci soddisfatti in quanto tutti questi sono contenuti all'interno delle soglie prefissate.
	I voti che abbiamo ottenuto per i documenti consegnati e per la presentazione sono stati rispettivamente 26 e 30, con una media ponderata di 27.\\
	Questo voto rispecchia il nostro volere di migliorare rispetto quello ottenuto alla \RR~ in quanto abbiamo dimostrato di aver capito gli errori commessi e le migliorie necessarie. Tuttavia anche questa volta abbiamo deciso di dover dare più importanza alla parte di verifica per permettere che non ci siano errori (logici e ortografici) e che tutti i membri siano a conoscenza del contenuto dei documenti.
	...
	Nonostante questo abbiamo raggiunto gli obiettivi prefissati e raffinato i casi d'uso che precedentemente non avevamo capito fino in fondo.
	...
	%\subsubsection{Considerazioni sui risultati e sull'esito della revisione}
	%\paragraph{Considerazioni Product Baseline (PB)}
