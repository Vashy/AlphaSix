...
I test che vengono introdotti nel corso del progetto non vanno a sostituire i test precedentemente sviluppati. Ogni test, appena è creato viene eseguito periodicamente fino alla fine del progetto, per evitare che i nuovi cambiamenti possano reintrodurre errori precedentemente risolti.
	...
	Essi contengono i valori ottenuti nel tempo e mostrano con chiarezza l'andamento delle misurazioni che abbiamo effettuato.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\textwidth]{img/MPD001Gulpease.png}
	...
	\begin{itemize}
		...
		\item \textbf{Descrizione}: ogni documento ha degli alti e bassi nel corso della stesura, ma infine rispetta i valori desiderati.
		\item \textbf{Valutazione}: Soddisfacente.
		\item \textbf{Considerazioni}: prevediamo di rimanere in questi valori anche per i prossimi periodi.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Descrizione}: ogni documento presenta qualche errore nel corso della stesura, ma infine rispetta i valori desiderati.
		\item \textbf{Valutazione}: Soddisfacente.
		\item \textbf{Considerazioni}: prevediamo di rimanere in questi valori anche per i prossimi periodi.
	\end{itemize}
	...
	\begin{figure}[H]
		...
		\includegraphics[width=0.9\textwidth]{img/MPD001Gulpease.png}
		\label{immaginegulpease}
		\caption{Diagramma con valori misurati tramite MPR003 Aderenza agli standard}
	\end{figure}
