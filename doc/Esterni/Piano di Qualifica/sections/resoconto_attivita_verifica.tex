...
I test che vengono introdotti nel corso del progetto non vanno a sostituire i test precedentemente sviluppati. Ogni test, appena è creato viene eseguito periodicamente fino alla fine del progetto, per evitare che i nuovi cambiamenti possano reintrodurre errori precedentemente risolti.
	...
	\paragraph{Documenti}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.9\textwidth]{img/cruscotti/MPD001_V2.png}
			\label{immaginegulpease}
			\caption{Diagramma con valori misurati tramite MPD001 Indice di Gulpease}
		\end{figure}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.9\textwidth]{img/cruscotti/MPD002_V2.png}
			\label{immagineCorrettezzaOrtografica}
			\caption{Diagramma con valori misurati tramite MPD002 Correttezza ortografica}
		\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\textwidth]{img/cruscotti/MPR004_V2.png}
		\label{immagineFrequenzaCommit}
	...
	\begin{itemize}
		...
		produttiva.
		\item \textbf{Valutazione}: soddisfacente.
		\item \textbf{Considerazioni}: studiando il diagramma e confrontandolo con quello del periodo
		precedente in \RP\ notiamo che il numero di commit è stato più lineare e con meno discostamenti,
		sintomo di un lavoro costante e di un maggior impegno.
	\end{itemize}
