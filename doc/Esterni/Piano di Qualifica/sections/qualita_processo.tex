...
Per questo è necessario operare con un buon \gloss{ciclo di vita} per i processi, che devono venire verificati e valutati adeguatamente. A questo scopo viene seguito lo schema del ciclo di Deming e dell'ISO 15504 descritti all'Appendice \S\ref{StandardQualita}.
