...
determina quali processi attivare e che devono essere verificati e valutati adeguatamente. A questo scopo viene seguito lo schema del \gloss{ciclo di Deming} e dell'\gloss{ISO 15504} descritti all'Appendice \S\ref{standard di qualità}.
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{YYY}
		...
		\rowcolor{\grigiodesc} \multicolumn{3}{>{\hsize=\dimexpr3\hsize+4\tabcolsep}X}{\textbf{Descrizione}: le scadenze riportate nel \PdP\ considerano anche un tempo di \gloss{slack} per eventuali ritardi. Il completamento di un compito assegnato, che per noi corrisponde alla chiusura di una \gloss{issue}, può quindi possedere fino a un ritardo massimo di due giorni.} \\
