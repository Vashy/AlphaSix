...
\begin{table}[H]
    {\def\arraystretch{1.4}
        \begin{tabularx}{\textwidth}{YYY}
            ...
            \rowcolor{white}
            QPR011 Progettare prima di codificare & MPR010 Moduli codificati prima della progettazione & 25\%\\
            ...
            \hline \rowcolor{white}
            QPR012 Usare un numero limitato di design pattern & MPR011 Numero di design pattern applicati & 5-6\\
            \rowcolor{\grigiodesc} \multicolumn{3}{>{\hsize=\dimexpr3\hsize+4\tabcolsep}X}{\textbf{Descrizione}: data la dimensione del progetto, 5 o 6 design pattern applicati ci sembrano un numero sufficiente per ottenere un codice di qualità non troppo complesso.}\\
        \end{tabularx}}
