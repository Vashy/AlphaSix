...
\begin{table}[H]
	\begin{VTtable}[1.7]{\textwidth}{cXc}
		...
		TV1 & Verifica la segnalazione dell' apertura di una issue da parte di Redmine:
		\begin{enumerate}
        ...
        TV2 & Verifica la segnalazione della modifica di una issue da parte di Redmine:
		\begin{enumerate}
        ...
        TV3 & Verifica la segnalazione dell' apertura di una issue da parte di GitLab:
		\begin{enumerate}
        ...
        TV4 & Verifica la segnalazione della modifica di una issue da parte di GitLab:
		\begin{enumerate}
...
\begin{table}[H]
	\begin{VTtable}[1.7]{\textwidth}{cXc}
        TV5 & Verifica di un evento di push da parte di GitLab:
		\begin{enumerate}
        ...
        TV6 & Verifica di invio di un messaggio di apertura issue dal Producer Redmine al Gestore Personale:
		\begin{enumerate}
        ...
        TV7 & Verifica di invio di un messaggio di modifica issue dal Producer Redmine al Gestore Personale:
		\begin{enumerate}
        ...
        TV8 & Verifica di scarto di messaggi non validi nel Producer Redmine:
		\begin{enumerate}
        ...
        TV9 & Verifica di invio di un messaggio di commit dal Producer GitLab al Gestore Personale:
		\begin{enumerate}
...
\begin{table}[H]
	\begin{VTtable}[1.7]{\textwidth}{cXc}
        TV10 & Verifica di invio di un messaggio di apertura issue dal Producer GitLab al Gestore Personale:
		\begin{enumerate}
        ...
        TV11 & Verifica di invio di un messaggio di modifica issue dal Producer GitLab al Gestore Personale:
		\begin{enumerate}
        ...
        TV12 & Verifica di scarto di messaggi non validi nel Producer GitLab:
		\begin{enumerate}
        ...
        TV13 & Verifica di invio di messaggi al Consumer Telegram:
		\begin{enumerate}
        ...
        TV14 & Verifica di invio di messaggi al Consumer Email:
		\begin{enumerate}
			\item Gestore Personale riceve un messaggio da un Producer (Redmine o GitLab).
            \item Gestore Personale rielabora il messaggio ricevuto.
			\item Gestore Personale invia il messaggio rielaborato.
...
\begin{table}[H]
	\begin{VTtable}[1.7]{\textwidth}{cXc}
        ...
        TV15 & Verifica di invio di messaggi al bot Telegram:
		\begin{enumerate}
        ...
        TV16 & Verifica di invio di messaggi al server email:
		\begin{enumerate}
		...
		TV17 & Verifica di accesso di un utente al sistema:
		\begin{enumerate}
        ...
        TV18 & Verifica di errore per identificativo inesistente:
		\begin{enumerate}
			\item Inserire nel gestore personale l'identificativo dell'utente (email o telegram)
			\item Confermare l' invio dei dati.
        ...
        TV19 & Verifica di uscita dell'utente dal sistema:
		\begin{enumerate}
        ...
        TV20 & Verifica di registrazione di un nuovo utente:
		\begin{enumerate}
        ...
        TV21 & Verifica di errore per identificativo già esistente:
		\begin{enumerate}
			\item Accedere al sistema.
            \item Inserire i seguenti campi:
                \begin{itemize}
        ...
        TV22 & Verifica di rimozione utente dal sistema tramite Telegram:
		\begin{enumerate}
			\item Accedere al sistema.
        ...
        TV23 & Verifica di rimozione utente dal sistema tramite email:
		\begin{enumerate}
			\item Accedere al sistema.
        ...
        TV24 & Verifica di errore nella rimozione di un utente inesistente dal sistema:
		\begin{enumerate}
			\item Accedere al sistema.
        ...
        TV25 & Verifica di rimozione dell'utente acceduto dal sistema:
		\begin{enumerate}
			\item Accedere al sistema.
        ...
        TV26 & Verifica di modifica di un utente:
		\begin{enumerate}
			\item TODO
		\end{enumerate}
		& \TNI \\\midrule
...
\begin{table}[H]
	\begin{paddedtablex}[1.7]{\textwidth}{cXc}
		...
		\newTI{Verifica l'integrazione di un file JSON con le componenti Consumer}{\TNI}
			...
			\subTI{Verifica l'integrazione di un file JSON con il Consumer Email}{\TNI}
		\newTI{Verifica l'integrazione di Kafka con le componenti Producer}{\TNI}
			\subTI{Verifica l'integrazione di Kafka nel Producer Gitlab}{\TNI}
			\subTI{Verifica l'integrazione di Kafka nel Producer Redmine}{\TNI}
		\newTI{Verifica l'integrazione di Kafka con le componenti Consumer}{\TNI}
			\subTI{Verifica l'integrazione di Kafka nel Cosumer Telegram}{\TNI}
			\subTI{Verifica l'integrazione di Kafka nel Consumer Email}{\TNI}
		\newTI{Verifica l'integrazione del database MONGODB con l'interfaccia del Gestore Personale}{\TNI}
		\newTI{Verifica l'integrazione delle componenti HTML con il server}{\TNI}
