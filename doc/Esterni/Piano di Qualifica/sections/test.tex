...
\begin{table}[H]
	\begin{paddedtablex}[1.7]{\textwidth}{cXc}
		...
		TI6.1 & Verifica l'integrazione di KafkaProducer con Producer GitLab & \TNI \\
		TI6.2 & Verifica l'integrazione di KafkaProducer con Producer Redmine & \TNI \\
		TI6.3 & Verifica l'integrazione di KafkaConsumer con Cosumer Telegram & \TNI \\
		TI6.4 & Verifica l'integrazione di KafkaConsumer con Consumer Email & \TNI \\
		TI7 & Verifica l'integrazione del database MongoDB con l'interfaccia del Gestore Personale & \TI \\
		TI8 & Verifica l'integrazione del database MongoDB con la componente di processamento dei messaggi & \TI \\
		\bottomrule\\
	\end{paddedtablex}
