...
\subsection{Test d'integrazione} \label{testintegrazione} %TODO
...
\end{table}
	...
	\begin{table}[H]
		...
		{\def\arraystretch{1.4}
		\begin{tabularx}{\textwidth}{YY}
			\textbf{Codice} & \textbf{Metodo} \\
			\toprule
			TI1 & metodo da inserire \\
			TI2 & metodo da inserire \\
			\bottomrule\\
		\end{tabularx}}
		\caption{Elenco dei test in correlazioni con le compoenti del codice.}
	\end{table}
