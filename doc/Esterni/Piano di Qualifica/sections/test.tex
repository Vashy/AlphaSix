...
\setcounter{tu}{0}
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			\addtotu & Verifica l'inserimento di un topic nel database & \TS \\
			\addtotu & Verifica la rimozione di un topic dal database & \TS \\
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			\addtotu & Verifica la presenza di un topic, legato al progetto dato, nel database & \TS \\
			\addtotu & Verifica la presenza di un topic, legato all'utente dato, nel database & \TS \\
			\addtotu & Verifica l'aggiornamento di una preferenza utente nel database & \TS \\
			...
			\addtotu & Verifica l'aggiunta di un topic alla lista dei topic utente nel database & \TS \\
			\addtotu &  & \TS \\
			\addtotu &  & \TS \\
			\addtotu &  & \TS \\
			\addtotu &  & \TS \\
	...
	\paragraph{Tracciamento} \label{tracciamentounita}
		...
		\begin{table}[H]
			...
			\begin{tabularx}{\textwidth}{cY}
				...
				\addtotu & DBController.insert\_user() \\
				\addtotu & DBController.delete\_one\_user()\\
				\addtotu & DBController.insert\_topic()\\
				\addtotu & DBController.delete\_one\_topic() \\
				\addtotu & DBController.user\_exists() \\
				\addtotu & DBController.project\_exists() \\
				\addtotu & DBController.topic\_exists() \\
				\addtotu & DBController.topic\_from\_id\_exists() \\
				\addtotu & DBController.update\_user\_preference() \\
				\addtotu & DBController.update\_user\_telegram() \\
				\addtotu & DBController.update\_user\_email() \\
				\addtotu & DBController.update\_user\_name() \\
				\addtotu & DBController.update\_user\_surname() \\
				\addtotu & DBController.add\_user\_topic() \\
				\addtotu & DBController.add\_user\_topic\_from\_id() \\
				\addtotu & \\
				\addtotu & \\
				\addtotu & \\
				\addtotu & \\
