...
\begin{table}[H]
	\begin{paddedtablex}[1.7]{\textwidth}{cXc}
        ...
        \rowcolor{white}\addtots & Verifica di aggiunta dei giorni di indisponibilità al calendario & NI \\
		\rowcolor{\tablegray}\addtots & Verifica di aggiunta della piattaforma di messaggistica preferita & NI \\
        \rowcolor{white}\addtots & Verifica di aggiunta della persona di fiducia & NI \\
        \rowcolor{\tablegray}\addtots & Verifica di errore nell'aggiunta di una persona di fiducia inesistente & NI \\
        \rowcolor{white}\addtots & Verifica di aggiunta delle keyword per i push di GitLab & NI \\
        \rowcolor{\tablegray}\addtots & Verifica di errore nell'aggiunta delle keyword per i push di GitLab già esistenti & NI \\
        \rowcolor{white}\addtots & Verifica di rimozione di un topic & NI \\
        \rowcolor{\tablegray}\addtots & Verifica di rimozione dei giorni di indisponibilità dal calendario & NI \\
        \rowcolor{white}\addtots & Verifica di rimozione della piattaforma di messaggistica preferita & NI \\
        \rowcolor{\tablegray}\addtots & Verifica di rimozione dellas persona di fiducia & NI \\
        \rowcolor{white}\addtots & Verifica di errore nella rimozione di una persona di fiducia inesistente & NI \\
        \rowcolor{\tablegray}\addtots & Verifica di rimozione delle keyword per i push di GitLab & NI \\
        \rowcolor{white}\addtots & Verifica di errore nella rimozione delle keyword inesistenti per i push di GitLab & NI \\
