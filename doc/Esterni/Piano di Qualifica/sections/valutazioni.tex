...
\section{Valutazioni per il miglioramento}	\label{valutazioni per il miglioramento}
    ...
    \subsubsection{Valutazione sugli strumenti}
        ...
        \paragraph{Docker}
            \begin{itemize}
                \item \textbf{problema riscontrato}: conoscere una nuova tecnologia richiede tempo, e nel nostro caso con \gloss{Docker} abbiamo impiegato più del previsto a conoscerne le caratteristiche a noi interessate.
