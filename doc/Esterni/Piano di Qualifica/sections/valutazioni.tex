...
\section{Valutazioni per il miglioramento}	\label{C}
	...
	\subsection{Valutazione dei ruoli}
		...
		\subsubsection{Analista}
			\begin{itemize}
				\item \textbf{Problema riscontrato}: la principale difficoltà è stata la stesura dell'\AdR\ in quanto i contenuti di questo documento sono nuovi e di difficile comprensione per i componenti del gruppo. In particolar modo l'individuazione dei corretti \gloss{casi d'uso} del progetto.
