...
%FIXME: dire a che minghie serve sta roba e quali punti in particolare
	...
	\begin{itemize}
		\item \textbf{Qualità interna}: misura la qualità di chi causa l'esecuzione del prodotto, in questo caso parliamo del codice sorgente a cui si possono aggiungere diverse metriche attraverso l'analisi statica. Queste poi possono stabilire la manutenibilità e portabilità del prodotto.
