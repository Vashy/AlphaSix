...
\section{Introduzione}
	...
	Tale documento ha l'obiettivo di esporre e analizzare i \gloss{requisiti} espliciti e impliciti per la realizzazione del progetto \progetto\ (C1) proposto dall'azienda \II.
