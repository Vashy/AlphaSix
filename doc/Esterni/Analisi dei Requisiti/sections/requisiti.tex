...
\addtocounter{vaZ}{1}%far partire il contatore da 1
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			%presi dal PdQ processi
			R\addQNumber
			Q1 & I costi previsti dalla \gloss{pianificazione} non dovrebbero variare più di quanto stabilito & Interno QPR002\\ 
			R\addQNumber 
			Q1 & Il livello di maturità dell'\gloss{ISO/IEC 15504} che ci siamo prefissati di raggiungere  deve essere almeno pari al livello stabilito & Interno QPR003\\
			R\addQNumber
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			%presi da capitolato
			R\addQNumber
			Q2 & Le applicazioni sviluppate devono rispettare i fattori trattati in The Twelve-Factor App segnati nel \PdQd & Capitolato \Doc{VE\_2018-12-12}	\\
			R\addQNumber
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			R5.1V2 & I file README delle componenti applicative devono contenere la documentazione delle \gloss{API} esposte dal servizio & Capitolato \\
