...
\addtocounter{X}{1}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				...
				\multirow{2}{*}{R8.2.2F2}
				& Interno \\
				& UC7.2.2-GP \\\cline{2-2}
				\multirow{2}{*}{R9F2}
				& Interno \\
				& UC7.2.3-GP \\\cline{2-2}
				\multirow{2}{*}{R10F2}
				& Interno \\
				& UC8-CT \\\cline{2-2}
				\multirow{2}{*}{R11F2}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				...
				\multirow{2}{*}{R17.3F2}
				& Interno \\
				& UC14.1.3-GP \\\cline{2-2}
				\multirow{2}{*}{R17.3.1F2}
				& Interno \\
				& UC14.2-GP \\\cline{2-2}
				\multirow{2}{*}{R17.4F2}
				& Interno \\
				& UC14.1.4-GP \\\cline{2-2}
				\multirow{2}{*}{R17.4.1F2}
				& Interno \\
				& UC14.2-GP \\\cline{2-2}
				\multirow{2}{*}{R18F2}
				& Interno \\
				...
				\multirow{2}{*}{R18.1F2}
				& Interno \\
				& UC15.1.1-GP \\\cline{2-2}
				\multirow{2}{*}{R18.2F2}
				& Interno \\
				& UC15.1.2-GP \\\cline{2-2}
				\multirow{2}{*}{R18.3F2}
				& Interno \\
				& UC15.2-GP \\\cline{2-2}
				\multirow{2}{*}{R18.4F2}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				...
				\multirow{2}{*}{R19.3F2}
				& Interno \\
				& UC16.1.1.2-GP \\\cline{2-2}
				\multirow{2}{*}{R19.4F2}
				& Interno \\
				& UC16.1.1.3-GP \\\cline{2-2}
				\multirow{2}{*}{R19.4.1F2}
				& Interno \\
				& UC16.1.2-GP \\\cline{2-2}
				\multirow{2}{*}{R19.5F2}
				& Interno \\
				& UC16.1.1.4-GP \\\cline{2-2}
				\multirow{2}{*}{R19.5.1F2}
				& Interno \\
				& UC16.1.2-GP \\\cline{2-2}
				\multirow{2}{*}{R20F2}
				& Interno \\
				...
				& Interno \\
				& UC17.4-GP \\\cline{2-2}
				\multirow{2}{*}{R20.4.1F2}
				& Interno \\
				& UC17.5-GP \\\cline{2-2}
				\multirow{2}{*}{R20.4.2F2}
				& Interno \\
				& UC17.5-GP \\\cline{2-2}
				\multirow{2}{*}{R20.5F2}
				& Interno \\
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				...
				& Interno \\
				& UC18.4-GP \\\cline{2-2}
				\multirow{2}{*}{R21.4.1F2}
				& Interno \\
				& UC18.5-GP \\\cline{2-2}
				\multirow{2}{*}{R21.4.2F2}
				& Interno \\
				& UC18.5-GP \\\cline{2-2}
				\multirow{2}{*}{R21.5F2}
				& Interno \\
				& UC18.6-GP \\\cline{2-2}
				\multirow{2}{*}{R21.5.1F2}
				& Interno \\
				& UC18.7-GP \\\cline{2-2}
				R22F2 & Capitolato \\\cline{2-2}
				R23F2 & Capitolato \\\cline{2-2}
				R24F2 & Capitolato \\\cline{2-2}
				R25F2 & Capitolato \\\cline{2-2}
				R26F2 & Capitolato \\\cline{2-2}
				R27F2 & Capitolato \\
				\bottomrule
			\end{oldtabularx}}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				...
				& Interno \\
				& QPR009 \\\cline{2-2}
				R8Q2 & Interno \\\cline{2-2}
				R9Q2 & Interno \\\cline{2-2}
				\multirow{2}{*}{R10Q2}
				& Capitolato \\
				& \Doc{VE\_2018-12-12} \\\cline{2-2}
				R11Q2 & Capitolato \\\cline{2-2}
				 &  \\\cline{2-2}
				 &  \\\cline{2-2}
				 &  \\\cline{2-2}
				 &  \\\cline{2-2}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				...
				\bottomrule
			\end{oldtabularx}}
			\caption{Elenco dei requisiti di vincolo in rapporto alle fonti (1)}
		\end{table}
