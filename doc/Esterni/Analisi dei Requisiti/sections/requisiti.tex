...
#1 & #2 & #3 \\
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
            ...
            \rowcolor{\tablegray}\ReqQ{1}{L'intera progettazione del progetto non deve contenere un numero di pattern più alto di quanto segnalato nel \PdQv}{Interno QPR012}
