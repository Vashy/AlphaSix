...
#1 & #2 & #3 \\
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}%0 opz  2 obb
			...
			%\stepcounter{vaF}
			\ReqF{0}{L'utente acceduto deve poter aggiungere le proprie preferenze sistema}{Interno UC17-GP}
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}%0 opz  2 obb
			\textbf{Codice} & \textbf{Requisito} & \textbf{Fonte} \\\toprule
				...
				\subReqF{0}{L'utente acceduto deve poter aggiungere nuove keyword di interesse per i messaggi di commit}{Interno UC17.6-GP}
			...
			%\stepcounter{vaF}
			\ReqF{0}{L'utente acceduto deve poter rimuovere le proprie preferenze sistema}{Interno UC18-GP}
				...
				\subReqF{0}{L'utente acceduto deve poter rimuovoere una piattaforma di messaggistica preferita}{Interno UC18.3-GP}
				...
				\subReqF{0}{L'utente acceduto deve poter rimuovere keyword di interesse per i messaggi di commit}{Interno UC18.6-GP}
	...
	\subsection{Tracciamento}\label{Tracciamento}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{\textwidth}{YY}
				...
				UC12.1-GP & R14F0 \\\cline{2-2}
				UC12.1.1 & R14.1F0 \\\cline{2-2}
				UC12.1.2 & R15F0 \\\cline{2-2}
				UC13-GP & R16F0 \\\cline{2-2}
				UC14-GP & R17F0 \\\cline{2-2}
				UC14.1.1-GP & R17.1F0 \\\cline{2-2}
				UC14.1.2-GP & R17.2F0 \\\cline{2-2}
				UC14.1.3-GP & R17.3F0 \\\cline{2-2}
				\multirow{2}{*}{UC14.2-GP}
				 & R17.3.1F0 \\
				 & R17.4.1F0 \\\cline{2-2}
				UC14.1.4-GP & R17.4F0 \\\cline{2-2}
				UC15-GP & R18F0 \\\cline{2-2}
				UC15.1.1-GP & R18.1F0 \\\cline{2-2}
				UC15.1.2-GP & R18.2F0 \\\cline{2-2}
				UC15.2-GP & R18.3F0 \\\cline{2-2}
				UC15.3-GP & R18.4F0 \\\cline{2-2}
				UC16-GP & R19F0 \\\cline{2-2}
				UC16.1-GP & R19.1F0 \\\cline{2-2}
				UC16.2-GP & R19.1.1F0 \\\cline{2-2}
				UC16.1.1.1-GP & R19.2F0 \\\cline{2-2}
				UC16.1.1.2-GP & R19.3F0 \\\cline{2-2}
				UC16.1.1.3-GP & R19.4F0 \\\cline{2-2}
				\multirow{2}{*}{UC16.1.2-GP}
				 & R19.4.1F0 \\
				 & R19.5.1F0 \\\cline{2-2}
				 UC16.1.1.4-GP & R19.5F0 \\\cline{2-2}
				 UC17-GP & R20F0 \\\cline{2-2}
				 UC17.1-GP & R20.1F0 \\\cline{2-2}
				 UC17.2-GP & R20.2F0 \\\cline{2-2}
				 UC17.3-GP & R20.3F0 \\\cline{2-2} 
			   \bottomrule \\
		   \end{oldtabularx}}
		...
		\begin{oldtabularx}{\textwidth}{YY}
			\textbf{Fonte} & \textbf{Requisito} \\
			\toprule	   
			UC17.4-GP & R20.4F0 \\\cline{2-2}
			\multirow{2}{*}{UC17.5-GP}
			 & R20.4.1F0 \\
			 & R20.4.2F0 \\\cline{2-2}
			 UC17.6-GP & R20.5F0 \\\cline{2-2}   
			 UC17.7-GP & R20.5.1F0 \\\cline{2-2}
			 UC18-GP & R21F0 \\\cline{2-2}
			 UC18.1-GP & R21.1F0 \\\cline{2-2}
			 UC18.2-GP & R21.2F0 \\\cline{2-2} 	   
			 UC18.3-GP & R21.3F0 \\\cline{2-2}
			 UC18.4-GP & R21.4F0 \\\cline{2-2}
			 \multirow{2}{*}{UC18.5-GP}
			 & R21.4.1F0 \\
			 & R21.4.2F0 \\\cline{2-2}	   
			 UC18.6-GP & R21.5F0 \\\cline{2-2}
			 UC18.7-GP & R21.5.1F0 \\
		  \bottomrule \\
	  	\end{oldtabularx}}
...
\addtocounter{X}{1}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				...
				R12Q2 & Capitolato \\\cline{2-2}
				R12.1Q2 & Capitolato \\\cline{2-2}
				R13Q2 & Capitolato \\\cline{2-2}
				R13.1Q2 & Capitolato \\\cline{2-2}
				R13.2Q2 & Capitolato \\\cline{2-2}
				R13.3Q2 & Capitolato \\\cline{2-2}
				R14Q1 & Capitolato \\\cline{2-2}
				R14.1Q2 & Capitolato \\
				\bottomrule
			\end{oldtabularx}}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				\textbf{Requisito} & \textbf{Fonte} \\
				\toprule
				R15Q2 & Capitolato \\\cline{2-2}
				R15.1Q2 & Capitolato \\\cline{2-2}
				R15.2Q2 & Capitolato \\\cline{2-2}
				R15.3Q2 & Capitolato \\\cline{2-2}		
				R15.3.1F2 & Capitolato \\\cline{2-2}
		...
		\begin{table}[H]
			...
			\begin{oldtabularx}{0.7\textwidth}{YY}
				\textbf{Requisito} & \textbf{Fonte} \\
				\toprule
				R1V2 & Capitolato \\\cline{2-2}
				R1.1V0 & Capitolato \\\cline{2-2}
				R2V2 & Capitolato \\\cline{2-2}
				R2.1V0 & Capitolato \\\cline{2-2}
				R3V2 & Capitolato \\\cline{2-2}
				R3.1V2 & Capitolato \\\cline{2-2}
				R4V1 & Capitolato \\\cline{2-2}
				R5V1 & Capitolato \\\cline{2-2}
				R6V0 & Interno \\\cline{2-2}
				R7V0 & Interno \\\cline{2-2}
				R7V0 & Interno \\\cline{2-2}
				R9V0 & Interno \\\cline{2-2}
				R10V0 & Interno \\
				\bottomrule
			\end{oldtabularx}}
