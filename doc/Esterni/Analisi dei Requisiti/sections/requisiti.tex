...
%			Q1 & Il diario di un documento dovrebbe essere aggiornato ad ogni modifica effettuata & Interno \\
			%presi da capitolato
			R\addQNumber
			Q2 & Le applicazioni sviluppate devono rispettare i fattori trattati in \gloss{The Twelve-Factor App} segnati nel \PdQd & Capitolato \textit{VE\_12-12-2018}\D	\\ %TODO:inserire verbale in cui ci siamo trovati con Imola
			R\addQNumber
...
\addtocounter{X}{1}	
		...
		\begin{paddedtablex}[1.7]{\textwidth}{XX}
			...
			Q1 & Interno \\
			R\addVC
			Q2 & Capitolato \textit{VE\_12-12-2018}\D \\
			R\addVC
			Q2 & Capitolato \\
			R\addVC
			Q2 & Capitolato \\
