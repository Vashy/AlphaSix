...
#1 & #2 & #3 \\
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			\rowcolor{white}\ReqQ{2}{Tutte le \gloss{norme} inserite nelle \NdP\ devono essere rispettate}{Interno}
			\rowcolor{\tablegray}\ReqQ{2}{Tutti i vincoli presenti nel \PdQ\ devono essere rispettati}{Interno}
			\rowcolor{white}\ReqQ{2}{Le applicazioni sviluppate devono rispettare i fattori trattati in The Twelve-Factor App segnati nel \PdQd}{Capitolato \Doc{VE\_2018-12-12}}
