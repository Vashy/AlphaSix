...
#1 & #2 & #3 \\
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}%0 opz  2 obb
			...
			\rowcolor{\tablegray}\ReqF{0}{\progetto\ deve saper notificare l'utente se il tentativo di accesso non è andato a buon fine}{Interno UC9.2}
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			\rowcolor{\tablegray}\ReqQ{1}{Ogni documento deve attraversare tutte le fasi previste dal suo \gloss{ciclo di vita}}{Interno QPR008}
			\rowcolor{white}\ReqQ{1}{Viene stabilito il numero massimo di modifiche che può ricevere un prodotto prima di essere verificato}{Interno QPR009}
            \rowcolor{\tablegray}\ReqQ{1}{arg2}{Interno}
