...
#1 & #2 & #3 \\
	...
	\begin{table}[H]
		\begin{paddedtablex}[1.7]{\textwidth}{cXc}
			...
			\Qsubreq{1}{Per ogni problema aperto documentato è possibile allegare delle soluzioni da attuare in futuro}{Capitolato}
			\req{R\thevaQ.1}{Deve essere redatta una documentazione su eventuali problemi riscontrati rimasti ancora aperti al termine del progetto}{Capitolato}
			
			\Qsubreq{2}{È necessario presentare un file \gloss{README} per ogni componente}{Capitolato}
			\req{R\thevaQ.1V2}{I file README delle componenti applicative devono contenere la documentazione delle \gloss{API} esposte dal servizio}{Capitolato}
			\req{R\thevaQ.2V2}{I file README delle componenti applicative devono contenere le istruzioni per il loro utilizzo}{Capitolato}
			%TODO: R.. & I DockerFile devono essere comprensivi di script e file cfg..ecc?
			\req{R\thevaQ.3V2}{È necessario presentare un file README per il Dockerfile}{Capitolato}
			\req{R\thevaQ.4V2}{Il file README per il Dockerfile deve contenere le istruzioni per l'avvio}{Capitolato}
			\req{R\addQNumber.5V2}{Il file README per il Dockerfile deve contenere la documentazione delle configurazioni custom scelte}{Capitolato}
