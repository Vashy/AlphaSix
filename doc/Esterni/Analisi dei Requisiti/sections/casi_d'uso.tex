...
\subsubsection{UC\theuccount\ - Redmine/GitLab invia una segnalazione}
	...
	\begin{itemize}
		...
		\item \textbf{Precondizione}: l'applicazione esterna a \progetto\ ha subito una modifica e la segnala al sistema.
		\item \textbf{Postcondizione}: il Producer riceve la segnalazione dell'applicativo esterno.
