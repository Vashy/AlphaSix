\subsubsection{UC\theuccount-GP - Aggiunta preferenze}
	...
	\subsubsection{UC\theuccount.\thesubuccount-GP - Iscrizione Topic}
		...
		\begin{itemize}
			...
			\item \textbf{Attori primari}: utente.
			\item \textbf{Descrizione}: data la lista di Topic presenti per i progetti a cui è iscritto, l’utente ne seleziona uno o	più a cui è interessato, per poterne ricevere le notifiche. I Topic sono divisi per categoria e	comprendono label, progetto a cui sono legate e l'applicazione di provenienza: Redmine o GitLab.
			\item \textbf{Precondizione}: l'utente ha acceduto con l'identificativo corretto nel sistema e non ha già selezionato tutte le preferenze possibili proposte da \progetto.
