...
\end{itemize}
	...
	\subsubsection{UC\theuccount.\thesubuccount-GP - Rimozione utente dal sistema}
		...
		\begin{itemize}
			...
			\item \textbf{Attori primari}: utente.
			\item \textbf{Descrizione}: un utente, acceduto al sistema, rimuove un utente presente nel sistema tramite
			l'inserimento del suo contatto Email o Telegram. Questo utente può essere anche se stesso.
			\item \textbf{Precondizione}: un utente già presente nel sistema deve essere rimosso.
