\subsubsection{UC\theuccount-GP - Aggiunta preferenze}
	...
	\subsubsection{UC\theuccount.\thesubuccount-GP - Iscrizione Topic}
		...
		\begin{itemize}
			...
			\item \textbf{Attori primari}: utente.
			\item \textbf{Descrizione}: data la lista di Topic presenti per i progetti a cui è iscritto l’utente, esso ne seleziona uno o	più a cui è interessato, per poterne ricevere le notifiche. I Topic sono divisi per categoria e comprendono label (quali per esempio ``bug'' o ``fix'', ecc) o ``commit'', con progetto di appartenenza e
			applicazione di provenienza: Redmine o GitLab.
			\item \textbf{Precondizione}: l'utente ha acceduto con l'identificativo corretto nel sistema e non ha già selezionato tutte le preferenze possibili proposte da \progetto.
	...
	\subsubsection{UC\theuccount.\thesubuccount-GP - Aggiunta della piattaforma di messaggistica preferita}
		...
		\begin{itemize}
			...
			Questo non comporta l'aggiunta di identificativo Telegram o del proprio contatto Email, ma solo della selezione della preferenza tra le due tecnologie.
			\item \textbf{Precondizione}: l'utente ha acceduto con l'identificativo corretto nel sistema e non ha già selezionato tutte le preferenze possibili proposte da \progetto.
	...
	% 		\item \textbf{Precondizione}: l'utente ha acceduto con l'identificativo corretto nel sistema e non ha già selezionato la persona a cui inoltrare le notifiche.
    ...
    \begin{itemize}
        ...
        \item \textbf{Precondizione}: l'utente ha acceduto con l'identificativo corretto nel sistema e non ha già selezionato tutte le preferenze possibili proposte da \progetto.
        \item \textbf{Postcondizione}: la priorità per progetto è stata aggiunta.
        \item \textbf{Scenario principale}:
        \begin{enumerate}
            \item L'utente aggiunge le priorità i progetti di interesse
        \end{enumerate}
    \end{itemize}