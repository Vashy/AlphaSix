\subsubsection{UC\theuccount-GP - Accesso}
	...
	\subsubsection{UC\theuccount.\thesubuccount-GP - Accesso dell'utente nel sistema}
		\begin{figure}[H]
			\centering
				\includegraphics[width=0.6\textwidth]{img/casi_d'uso/UC12_1.png}\\
		...
		\begin{itemize}
			...
			\item \textbf{Attori primari}: utente non acceduto.
			\item \textbf{Descrizione}: l'utente non acceduto accede al sistema inserendo ciò che è richiesto gli è richiesto e inviandone la conferma.
			...
			\item \textbf{Scenario principale}:
			\begin{enumerate}
				\item L’utente non ancora riconosciuto dal sistema richiede l'accesso inserendo l'identificativo.
