...
%	\end{figure}
	\begin{itemize}
		...
		Altrimenti, se il destinatario è iscritto a quel Topic ma non è disponibile, il destinatario viene cambiato, ma si prosegue comunque all'invio verso il Consumer Telegram.\\
