	...
	\subsubsection{UC\theuccount.\thesubuccount-GP - Rimozione avvenuta con successo}
		...
		\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attori primari}: utente.
				\item \textbf{Descrizione}:  l’utente inserisce i propri campi per rimuoversi dal sistema.
				\item \textbf{Precondizione}: un utente già presente nel sistema deve essere rimosso.
				\item \textbf{Postcondizione}: l'utente non risulta più acceduto al sistema non riconosce più l'utente rimosso.
				\item \textbf{Scenario principale}:
				\begin{enumerate}
