\lettera{C}\label{C}
	...
	\parola{Code coverage}{
		Code covarage (in italiano copertura del codice) è la misura utilizzata per descrivere il grado di codice sorgente eseguito quando esegue una perticolare suite di test.
	}\label{Code Coverage}
