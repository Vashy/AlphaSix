\lettera{S}\label{S}
	...
	\parola{Scala}{%Usata solitamente per passare da un piano all'altro di un edificio quando, solitamente dopo le feste, si ha voglia di buttare giù qualche chilo
	...
	\parola{Slack}{%
		...
		Permette l'integrazione con strumenti di terze parti come \hyperref[Google Drive]{\gloss{Google Drive}}, Trello, \hyperref[GitHub]{\gloss{GitHub}}, Google Calendar ed altre applicazioni popolari. 
	}\label{Slack}
