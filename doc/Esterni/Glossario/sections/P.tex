\lettera{P}\label{P}
	...
	\parola{Pianificazione}{%
		Fase precedente allo svolgimento delle attività dove si decide la durata delle stesse e le risorse impiegate per il loro svolgimento.
	...
	\parola{Prodotto}{%
		Risultato finito e funzionante del lavoro fatto durante tutto lo svolgimento di un progetto. Il prodotto è ciò che viene consegnato infine al cliente. 
	}\label{Prodotto}
	...
	\parola{Proof of Concept (PoC)}{%
		Realizzazione abbozzata di un progetto o metodo, provandone la fattibilità e contetti costituenti.
	}\label{PoC}
