\lettera{A} \label{A}
	...
	\parola{Amazon}{%
		\`E è un'azienda di commercio elettronico statunitense, con sede a Seattle nello stato di Washington. Rappresenta
	...
	\parola{Azure}{%
		Microsoft Azure è un set di servizi \gloss{cloud} che aiuta le organizzazioni ad affrontare le sfide professionali. Permette di creare, gestire e distribuire applicazioni su una rete globale di dimensioni elevate.
	}\label{Azure}