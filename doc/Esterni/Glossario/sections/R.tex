\lettera{R}\label{R}
	...
	\parola{Redmine}{%
		\`E una piattaforma Web open-source per la gestione di progetti tramite diversi tool inerenti all'\gloss{Issue Tracking System}. Permette di creare le wiki dei progetti, diagrammi di \gloss{Gantt}, fare time-tracking e interfacciarsi con diversi Version Control System come \gloss{GitLab}.
	}\label{Redmine}
