\lettera{I}\label{I}
	...
	\parola{IOS}{%
		\`E è un sistema operativo sviluppato da Apple per iPhone, iPod touch e iPad.
	}\label{IOS}
	...
	\parola{Issue Tracking System}{
		...
		Ogni singola attività del progetto è gestita mediante un \gloss{workflow} e mantenuta all'interno di un’unica piattaforma e di un unico \gloss{repository}.
