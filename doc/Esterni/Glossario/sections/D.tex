\lettera{D} \label{D}
	...
	\parola{DevOps}{%
		\`E l'unione delle parole \gloss{Development\G} e \gloss{Operation\G}. Vuole intendere la pratica di veder collaborare in modo molto stretto queste due particolari fasi dello sviluppo software. \`E una strategia che prevede un rilascio del prodotto molto frequente aiutando le aziende nello standardizzare gli ambienti di sviluppo.
	}\label{DevOps}
	...
	\parola{Dockerfile}{
		Contiene le configurazioni necessarie per il container sul quale si andrà a eseguire l'applicativo.
	}\label{Dockerfile}
	...
	\parola{Draw.io}{
		È un software online gratis per diagrammi per creare diagrammi di flusso, UML e altri tipi di diagrammi.
	}\label{Draw.io}