...
\subsection{Aggiungere un MessageProcessor}

Per far conoscere al Gestore Personale la presenza di un nuovo tipo di Producer, è necessario implementare la logica di filtro degli utenti in base al tipo di messaggi
implementando una classe concreta che erediti da \texttt{Processor}.
Va implementato il metodo \texttt{filter\_users\_by\_topic()}.
