...
\begin{document}
    ...
    \section{Argomenti}
    	...
    	\begin{itemize}
    		\item \textbf{Le iscrizioni ai \gloss{Topic} devo poter differenziare la presenza di più progetti?}\\
            ...
            In Redmine è possibile assegnare ad ogni tipo di \gloss{issue} un \gloss{workflow}, perciò in base allo stato di queste la segnalazione può interessare utenti diversi. La tipologia di segnalazioni interessate può essere dunque molto ampia, importano però i destinatari delle issue.
    		\item \textbf{Le \gloss{keyword} presenti nei commit come possono essere meglio gestite?}\\
            Le keyword potrebbero essere gestite direttamente dal Gestore Personale.
    		\item \textbf{L'uso del linguaggio \gloss{Python} è una buona scelta?}\\
            Certamente.
    		...
    		\item \textbf{Pensavamo alla figura di un \gloss{sistemista} che avrebbe agito direttamente nel \gloss{database} di \gloss{Kafka} per inserire nuovi utenti o Topic, è una scelta implementativa ragionevole?}\\
