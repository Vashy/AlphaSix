\section{G\&B - C3} \label{c3}
    ...
    per Grafana che sfrutti l'intelligenza artificiale attraverso una \gloss{Rete Bayesiana} affinché il monitoraggio sia più efficace.
    ...
    \begin{itemize}
    	...
    	\item \gloss{Grafana}
    	\item \gloss{Rete Bayesiana}, attraverso la libreria \textit{jsbayes}
    	\item \gloss{GitHub}
    \end{itemize}

    \subsection{Valutazione conclusiva}
    Il capitolato richiede lo studio di strumenti inerenti l'\gloss{intelligenza artificiale}, un argomento ritenuto molto interessante dal team di sviluppo.
