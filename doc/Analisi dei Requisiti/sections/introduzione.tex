\section{Introduzione}
	...
	Tale documento ha l'obiettivo di esporre e analizzare i \gloss{requisiti} espliciti e impliciti per la realizzazione del progetto \textit{Butterfly} (C1) proposto dall'azienda \II.

	Il documento vuole fungere da base per la fase di progettazione del \gloss{software} in modo che essa sia conforme alle richieste fatte dall'azienda proponente.
	...
	come \gloss{Redmine}, \gloss{GitLab} e \gloss{Sonar}, attraverso un \gloss{Broker} che possa incanalare questi messaggi e distribuirli a strumenti come
	...
	\gloss{metadati}, di reindirizzare i messaggi ricevuti al destinatario più appropriato.
