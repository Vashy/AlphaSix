\section{Processi Organizzativi}
    ...
    \subsection{Gestione del progetto}
		...
		\subsubsection{Controllo del progetto}
			...
			stabiliti nel \Doc{\PdQ} e nell'\Doc{\AdR}. Risultano validi indicatori, per la valutazione di:
			\begin{itemize}
			...
			\begin{itemize}
				\item Per le comunicazioni interne verranno utilizzati gli strumenti segnalati in \S\ref{pianificazione e coordinamento}, in particolare
					...
					\begin{itemize}
						...
						\item appuntare il contenuto della riunione per poter poi redigere formalmente il verbale.
					\end{itemize}
