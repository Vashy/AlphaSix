\section{Processi Organizzativi}
    ...
    \subsection{Gestione del progetto}
		...
		Gli strumenti utilizzati possono essere software descritti nelle \NdPv\ o gli standard di qualità descritti nel \Doc{\PdQv}.
		Gli obiettivi che ci si pone di raggiungere sono descritti nel \PdQv.
		...
		\subsubsection{Chiusura dei processi}
			...
			opportunamente archiviate. % TODO Archiviate? Come? Dove?
	...
	\subsection{Formazione}
		...
		La formazione di ogni membro del team avviene tramite studio autonomo dei \gloss{framework} menzionati da \II\ durante la presentazione del progetto e incontri con \gruppo.
