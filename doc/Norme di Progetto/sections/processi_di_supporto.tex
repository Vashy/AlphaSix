	...
	\subsection{Verifica}
		...
		La denominazione delle metriche è già stata descritta in §3.1.3.3, qui viene descritto il loro funzionamento.
			...
			\paragraph{Metriche per i processi}
				...
				Per ogni attributo verrà infine indicata una percentuale di quanto il processo rispetti l'attributo, potendo infine
				capire nel complesso quanto quel processo riesca a superare un dato livello di maturità.
				
				\subparagraph*{Ciclo di Deming}
				Nel fase migliorativa del processo sarà data particolare attenzione nel non iniziale una fase del ciclo di Deming senza aver
				finito completamente le fasi precedenti.
