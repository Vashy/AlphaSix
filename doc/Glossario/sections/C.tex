\lettera{C}\label{C}
	...
	\parola{CMMI}{%
		...
		Questo standard fa leva sul determinare la capability di un processo, intesa come la misura della capacità e dell'efficienza per un processo di ottenere risultati, e maturity, intesa quanto l'azienda sia capace di organizzare e governare i suoi processi.
