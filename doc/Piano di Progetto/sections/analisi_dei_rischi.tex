...
\section{Analisi dei rischi} \label{AnalisiDeiRischi}
	...
	\begin{table}[H]
		...
		\begin{risktable}{\columnwidth}{m{1.5cm}m{13.5cm}}
			...
			\hline
			\multicolumn{2}{X}{
				\textbf{Strategia}: a ciascuna riunione di AlphaSix si controllerà se il lavoro svolto finora è pertinente a quanto è stato preventivato, modificando di conseguenza il consuntivo e il preventivo a finire.
