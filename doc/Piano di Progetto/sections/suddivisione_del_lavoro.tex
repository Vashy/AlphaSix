...
\section{Suddivisione del lavoro} \label{SuddivisioneDelLavoro}
	...
	\subsection{Dettaglio Fasi}
		...
		\subsubsection{Progettazione della Base Tecnologica}
			La suddivisione dei ruoli tra i vari membri del gruppo nel periodo di Progettazione della Base Tecnologica è la seguente.
		...
		\subsubsection{Validazione e Collaudo}
			La suddivisione dei ruoli tra i vari membri del gruppo nel periodo di Validazione e Collaudo è la seguente.
