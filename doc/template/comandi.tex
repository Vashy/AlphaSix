...
\newcommand{\NdPv}{NormeDiProgetto v4.0.0}

\newcommand{\PdP}{Piano di Progetto}
\newcommand{\PdPv}{PianoDiProgetto v4.0.0}

\newcommand{\SdF}{Studio di Fattibilità}
\newcommand{\SdFv}{StudioDiFattibilità v1.0.0}

\newcommand{\PdQ}{Piano di Qualifica}
\newcommand{\PdQv}{PianoDiQualifica v4.0.0}

\newcommand{\VI}{Verbale Interno}
\newcommand{\VE}{Verbale Esterno}

\newcommand{\MU}{Manuale Utente}
\newcommand{\MUv}{ManualeUtente v2.0.0}

\newcommand{\MS}{Manuale Sviluppatore}
\newcommand{\MSv}{ManualeSviluppatore v2.0.0}

\newcommand{\Gl}{Glossario}
\newcommand{\Glv}{Glossario v4.0.0}
...
\newcommand{\redmine}{Redmine 3.3.9}
